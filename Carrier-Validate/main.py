...
|  $$ / $$/|____  $$| $$| $$ /$$__  $$ |____  $$|_  $$_/   /$$__  $$
 \  $$ $$/  /$$$$$$$| $$| $$| $$  | $$  /$$$$$$$  | $$    | $$$$$$$$
  \  $$$/  /$$__  $$| $$| $$| $$  | $$ /$$__  $$  | $$ /$$| $$_____/
   \  $/  |  $$$$$$$| $$| $$|  $$$$$$$|  $$$$$$$  |  $$$$/|  $$$$$$$
    \_/    \_______/|__/|__/ \_______/ \_______/   \___/   \_______/'''.format(fg[7], fg[1]))
        # endregion Banner
...
'''.format(fg[6], fg[5], fg[0], fg[2], fg[1], fg[3]))
        print('\t{0}╭╼[ {5}Flash-Validate {0}]╾╼[ {1}Enter{4}/{1}Choice {0}]\n\t╰─╼ {2}'.format(fg[5], fg[6], fg[1], fg[3], fg[2], fg[0]), end='')
        choice = input('')
        if choice in ['1', '01']:
            self.load()
            self.execute()
    ...
    def load(self):
        ...
        while not is_numbers:
            print('\t{0}╭╼[ {5}Flash-Validate {0}]╾╼[ {1}Enter {3}Numbers{1} List {4}Filename {0}]\n\t╰─╼ {2}'.format(fg[5], fg[6], fg[1], fg[3], fg[2], fg[0]), end='')
    ...
    def execute(self):
        ...
        print('\t{0}╭╼[ {5}Flash-Validate {0}]╾╼[ {1}Thread{4}/{1}Workers {0}]\n\t╰─╼ {2}'.format(fg[5], fg[6], fg[1], fg[3], fg[2], fg[0]), end='')
        workers = int(input(''))
    ...
    def gen_state(self):
        ...
        is_done = False
        while not is_done:
            print('\t{0}╭╼[ {5}Flash-Validate {0}]╾╼[ {1}Enter{4}/{1}State {0}]\n\t╰─╼ {2}'.format(fg[5], fg[6], fg[1], fg[3], fg[2], fg[0]), end='')
    ...
    def gen_area_code(self):
        ...
        is_done = False
        while not is_done:
            print('\t{0}╭╼[ {5}Flash-Validate {0}]╾╼[ {1}Enter{4}/{1}AreaCode {0}]\n\t╰─╼ {2}'.format(fg[5], fg[6], fg[1], fg[3], fg[2], fg[0]), end='')
    ...
    def gen_prefix(self):
        ...
        is_done = False
        while not is_done:
            print('\t{0}╭╼[ {5}Flash-Validate {0}]╾╼[ {1}Enter{4}/{1}Prefix {0}]\n\t╰─╼ {2}'.format(fg[5], fg[6], fg[1], fg[3], fg[2], fg[0]), end='')
